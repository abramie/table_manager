...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $som = Evenement::factory()->create([
                ...
                'slug' => 'som-24',
                'date_debut' => \Carbon\Carbon::create(2026,05,11,10),
                'ouverture_inscription'=> \Carbon\Carbon::create(2026,01,01,21),
                'affichage_evenement' => \Carbon\Carbon::create(2026,01,01,21),
                'fermeture_inscription'=> \Carbon\Carbon::create(2026,05,11,10),
        ...
        $creneau_matin = Creneau::factory()->recycle($som)->create(
            array(
                ...
                'debut_creneau' => \Carbon\Carbon::create(2026,05,11,10),
            )
        );
        ...
        $creneau_aprem= Creneau::factory()->recycle($som)->create(
            array(
                ...
                'max_tables' => 8,
                'nb_inscription_online_max' => 2,
                'debut_creneau' => \Carbon\Carbon::create(2026,05,11,14),
            )
        );
        ...
        $creneau_soir = Creneau::factory()->recycle($som)->create(
            array(
                ...
                'max_tables' => 8,
                'nb_inscription_online_max' => 2,
                'debut_creneau' => \Carbon\Carbon::create(2026,05,11,21),
            )
        );
        ...
        $creneau_nuit =Creneau::factory()->recycle($som)->create(
            array(
                ...
                'max_tables' => 8,
                'nb_inscription_online_max' => 2,
                'debut_creneau' => \Carbon\Carbon::create(2026,05,12,03),
            )
        );
        /*
                DB::table('creneaux')->insert(
        ...
        */
        Table::factory()->recycle($creneau_matin)->create(
            array(
                ...
                'debut_table' => \Carbon\Carbon::create(2026,05,11,10)
            )
        );
        ...
        Table::factory()->recycle($creneau_soir)->create(
            array(
                ...
                'mj' => 2,
                'description' => "une partie tranquille d'extra humain",
                'debut_table' => \Carbon\Carbon::create(2026,05,11,14),
            )
        );
        ...
        Table::factory()->recycle($creneau_matin)->create(
            array(
                ...
                'debut_table' => \Carbon\Carbon::create(2026,01,19,21)
            )
        );
        ...
        Table::factory()->recycle($creneau_matin)->create(
            array(
                ...
                'debut_table' => \Carbon\Carbon::create(2026,06,19,21)
            )
        );
