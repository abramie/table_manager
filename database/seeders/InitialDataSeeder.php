...
class InitialDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $benevole = Role::create(['name' => 'benevole']);
        ...
        $etre_benevole = Permission::create(['name' => 'etre_benevole']);

        $permissions_mj = [$ajout_tables,$manage_tables_own,$ajout_tags,$ajout_tws];
        $permissions_modo = [$manage_tables_all,$ajout_events,$ajout_tags,$ajout_tws, $change_tags,$etre_benevole];
        ...
        $benevole->syncPermissions($etre_benevole);
